    ...
    <div className="card bg-base-100 w-96 shadow-xl hover:scale-105 hover:transition">
      ...
      <div className="card-body bg-neutral-900 gap-4">
        ...
        <div className="flex gap-2 justify-center">
          {data.data.github && <button className="btn btn-sm"><a href={data.data.github}>Github</a></button>}
          {data.data.demo && <button className="btn btn-sm"><a href={data.data.demo}>Demo</a></button>}
        </div>
      </div>
    </div>
  );
